...
Step1: To manage all of the player’s functions, a number of functions cooperate.Accessing the HTML components and defining all the variables.
...
let trackLoading = document.getElementById("trackLoading");
let currentTrackTimeBar = document.getElementById("currentTrackTimeBar");
Step2: We’ll make a variable called “musics.” This variable will contain an array, within of which we will keep various pieces of music along with their titles, artists, albums, cover images, and urls.
...
Step3: Now, we will add all of these values to our HTML elements using this array, and we will use a function to change the value of.innerHTML using the array value.

In order to switch between the various theme values, we will additionally add an even listener in which the switch statement will be used.
...
Step4: Now we will be adding another click eventListener to our music tracker which will be used in change the length of music tracked along wiht the music.we will add the javascript function to add the play and pause and volume increase and decrease function using javascript.
